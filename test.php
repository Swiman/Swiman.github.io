						...
						<form method="post" action="contact.php">
							<table id="contactTable">
							  <tr>
								...
								<td><input type="text" id="txtName" style="color:#000000" title="Enter your name" name="txtName" value="<?php echo $Name ?>" /></td>
							  </tr>
							  <tr>  
								<th><label for="txtPhone">Phone</label></th>
								<td><input  type="text" id="txtPhone" title="Enter your phone number" name="txtPhone" value="<?php echo $Phone ?>"/></td>
							  </tr>
							  <tr>  
								<th><label for="txtEmail">Email</label></th>
								<td><input  type="text" id="txtEmail" title="Enter your email address" name="txtEmail" value="<?php echo $EmailFrom ?>"/></td>
							  </tr>
							  <tr>
								<th class="message"><label for="txtMessage">Message</label></th>
								<td><textarea title="Enter your message" name="txtMessage" rows="10" cols="48" id="txtMessage"><?php echo $Message ?></textarea></td>
							  </tr>
							  <tr>
								<th><label title="Send your message"></label></th>
								<td><input type="submit" style="color:#000000" value="Send Message" /></td>
							  </tr>
							 </table>
						</form>
